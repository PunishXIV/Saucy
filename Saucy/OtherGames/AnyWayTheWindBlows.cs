...
public class AnyWayTheWindBlows : Module
{
    ...
    public override bool IsEnabled => Saucy.Config.AnyWayTheWindowBlowsModuleEnabled;
    ...
    public class Dot : Window
    {
        ...
        public override bool DrawConditions() => Player.Territory is 144 && Stage.FungahPresent && Stage.PlayerOnStage;
